...
export default function Section05NatureLocation() {
  ...
  const categories = {
    work: {
      ...
      icon: Building,
      items: [
        { name: 'Electronic City Phase 1 & 2', dist: '10–12 Mins', km: '6.5 km', note: 'Infosys & Wipro Tech Campuses' },
        { name: 'Bommasandra Industrial Corridor', dist: '8 Mins', km: '4.8 km', note: 'Biocon Park & Schneider Electric' },
        { name: 'Jigani Tech Corridor', dist: '14 Mins', km: '9.2 km', note: 'TVS Motor & HCL Technologies' },
        { name: 'Sarjapur IT Spine', dist: '20 Mins', km: '14.0 km', note: 'Wipro Corporate HQ & Tech Park' },
      ],
    },
    transit: {
      ...
      icon: Train,
      items: [
        { name: 'Hosur Road (NH 44 Expressway)', dist: '6 Mins', km: '3.2 km', note: 'Elevated 10-Lane Expressway' },
        { name: 'NICE Peripheral Ring Road', dist: '9 Mins', km: '5.6 km', note: 'Signal-Free Peripheral Ring Road' },
        { name: 'Bommasandra Metro Station', dist: '8–10 Mins', km: '4.8 km', note: 'Yellow Line Namma Metro Station' },
        { name: 'Proposed Metro Neo Extension', dist: '5 Mins', km: '2.8 km', note: 'Rapid Feeder Transit Corridor' },
      ],
    },
    health: {
      label: 'Healthcare',
      icon: HeartPulse,
      items: [
        { name: 'Narayana Health City', dist: '10 Mins', km: '5.2 km', note: 'Premier Multispecialty & Cardiac' },
        { name: 'Sparsh Superspecialty Hospital', dist: '12 Mins', km: '7.1 km', note: 'Tier-1 Trauma & Orthopedic Care' },
        { name: 'Vimalaya Multispecialty Hospital', dist: '8 Mins', km: '4.5 km', note: '24/7 Emergency & ICU Center' },
        { name: 'Mazumdar Shaw Cancer Center', dist: '11 Mins', km: '6.8 km', note: 'Advanced Oncology & Surgery' },
      ],
    },
    education: {
      ...
      icon: GraduationCap,
      items: [
        { name: 'Alliance University Campus', dist: '12 Mins', km: '7.0 km', note: 'Premier Engineering & Business' },
        { name: 'PES University South Campus', dist: '15 Mins', km: '9.8 km', note: 'Leading Technology & Research' },
        { name: 'Treamis World School', dist: '9 Mins', km: '5.2 km', note: 'IB & Cambridge World School' },
        { name: 'Delhi Public School (DPS) South', dist: '14 Mins', km: '8.9 km', note: 'Reputed K-12 Academy Campus' },
      ],
    },
  };
