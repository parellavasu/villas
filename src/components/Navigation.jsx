        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 h-full flex items-center justify-between">
            ...
            {navLinks.map((item) => {
              ...
              return (
                <a
                  ...
                  className={`font-sans text-[12px] font-semibold tracking-[0.04em] transition-all relative py-1.5 whitespace-nowrap cursor-pointer ${
                    isActive
          ...
          <div className="hidden md:flex items-center shrink-0">
            <button
              ...
              className="inline-flex items-center space-x-2 px-5 py-2.5 bg-[#EA580C] hover:bg-[#C2410C] text-white text-[11.5px] font-bold tracking-[0.04em] rounded-full transition-all duration-300 shadow-sm group whitespace-nowrap cursor-pointer"
            >
          ...
          <div className="flex flex-col space-y-5 text-center">
            ...
            {navLinks.map((item) => (
              <a
                ...
                className="font-sans text-[15px] font-semibold tracking-[0.04em] text-gray-800 hover:text-[#EA580C] py-2 border-b border-gray-100"
              >
                {item.label}
              </a>
            ))}
